...
(defproject scicloj/stdlang-docs "0.1.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.11.1"]
                 ...
                 [xyz.zcaudate/code.test           "4.0.7"]
                 [xyz.zcaudate/code.manage         "4.0.7"]
                 [xyz.zcaudate/code.java           "4.0.7"]
                 [xyz.zcaudate/code.maven          "4.0.7"]
                 [xyz.zcaudate/code.doc            "4.0.7"]
                 [xyz.zcaudate/code.dev            "4.0.7"]
                 [xyz.zcaudate/jvm                 "4.0.7"]
                 
                 [xyz.zcaudate/rt.basic            "4.0.7"]
                 [xyz.zcaudate/rt.redis            "4.0.7"]
                 [xyz.zcaudate/rt.postgres         "4.0.7"]
                 [xyz.zcaudate/rt.shell            "4.0.7"]
                 [xyz.zcaudate/rt.solidity         "4.0.7"]

                 [xyz.zcaudate/std.lib             "4.0.7"]
                 [xyz.zcaudate/std.log             "4.0.7"]
                 [xyz.zcaudate/std.lang            "4.0.7"]
                 [xyz.zcaudate/std.text            "4.0.7"]
                 [xyz.zcaudate/xtalk.db            "4.0.7"]
                 [xyz.zcaudate/xtalk.lang          "4.0.7"]
                 [xyz.zcaudate/xtalk.system        "4.0.7"]]
